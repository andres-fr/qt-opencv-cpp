...
dist: 
	@test -d .tmp/webcam1.0.0 || mkdir -p .tmp/webcam1.0.0
	$(COPY_FILE) --parents $(DIST) .tmp/webcam1.0.0/ && $(COPY_FILE) --parents design.h .tmp/webcam1.0.0/ && $(COPY_FILE) --parents WEBCAM.cpp .tmp/webcam1.0.0/ && (cd `dirname .tmp/webcam1.0.0` && $(TAR) webcam1.0.0.tar webcam1.0.0 && $(COMPRESS) webcam1.0.0.tar) && $(MOVE) `dirname .tmp/webcam1.0.0`/webcam1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/webcam1.0.0
