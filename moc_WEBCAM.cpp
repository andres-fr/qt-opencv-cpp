/****************************************************************************
** Meta object code from reading C++ file 'WEBCAM.cpp'
**
...
#error "The header file 'WEBCAM.cpp' doesn't include <QObject>."
...
void *WebCam::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::MainWindow"))
        return static_cast< Ui::MainWindow*>(const_cast< WebCam*>(this));
